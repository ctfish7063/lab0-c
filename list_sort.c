...
/*
 * Not sure if linux __u8 is equavelent to C standard uint8_t
 * This is a quick fix to make it compile
 */
typedef uint8_t u8;

/*
 * Compare two elements.  This is the only function that needs to be
 * provided by the client.  It should return a negative value if a
 * precedes b, zero if a and b are equivalent, and a positive value if
 * a follows b.
 */
